...
class SeoChromeTests(unittest.TestCase):
    def test_page_title_is_unique_and_branded(self):
        ...
        self.assertEqual(home, uadb.BRAND)
        self.assertIn("Union Arena", home)
        self.assertNotIn("Standard", home)
        self.assertEqual(uadb.page_title(""), uadb.BRAND)
    ...
    def test_seo_head_has_description_canonical_and_og(self):
        ...
        self.assertIn("data-theme-toggle", chrome)
        self.assertIn("uadb-theme", chrome)
        self.assertIn("header-tools", chrome)
        ...
        self.assertIn("uadb-theme", home)
        self.assertIn("<title>Union Arena Decklists</title>", home)
        self.assertNotIn("Standard TCG 50-card lists", home)
