...
class RaidTests(unittest.TestCase):
    ...
    def test_home_markup(self):
        ...
        self.assertIn("Add this list to your hand", html)
        self.assertIn("[Raid]", html)
        self.assertIn("Copy one and raid", html)
        self.assertNotIn("Public lists by title", html)
        self.assertNotIn("Public Union Arena TCG lists by anime and manga title", html)
        self.assertNotIn("50-card lists for Standard", html)
        self.assertNotIn("50-card Union Arena TCG lists for Standard", html)
...
class NewestSetPieTests(unittest.TestCase):
    ...
    def test_home_includes_newest_set_pie(self):
        ...
        self.assertIn('viewBox="0 0 1200 840"', html)
        self.assertIn("pie-callout-bg", html)
        self.assertGreaterEqual(PIE_VIEW_W, 1100)
        self.assertGreaterEqual(PIE_R, 280)
