...
`/setup` creates `#welcome`, `#announcements`, `#roles`, title roles, and one channel per anime or manga (`#solo-leveling`, `#yu-yu-hakusho`, …). Each channel gets that title’s consensus 50s.
